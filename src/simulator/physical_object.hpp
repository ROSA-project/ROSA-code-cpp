...
/**
 * A general rigid physical object, i.e. does not change shape by assumption, and is evolved as if it is a point with no shape.
 * Hence, e.g. no rotation. The object has acceleration and velocity in addition to the position.
 */
...
public:
    ...
    /**
     * Overriding that of Object. A RigidPhysicalObject basically keeps moving based on acceleration and velocity and changes state upon bumps.
